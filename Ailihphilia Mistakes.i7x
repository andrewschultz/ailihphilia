...
understand "stank nats" and "stank nat's" as a mistake ("Yes, it's pretty awful.[mis of 32]") when nat's tan is quicknear.

understand "tank nat" as a mistake ("No, even a small amount of Nat's is enough.[mis of 33]") when nat's tan is quicknear.

understand "tang nat" as a mistake ("It's probably already too tangy.[mis of 34]") when nat's tan is quicknear.

understand "tannin nat" as a mistake ("It probably has enough weird, horrible ingredients.[mis of 35]") when nat's tan is quicknear.

understand "stan nats" and "stan nat's" as a mistake ("Well, Nat's must have its stans, but you don't want to be one.[mis of 36]") when nat's tan is quicknear.
...
understand "par trap" as a mistake ("You aren't on a golf course.[mis of 39]") when Verses Rev is quicknear.

understand "par crap" as a mistake ("Making fun of others['] clothing isn't as evil as the Diktat Kid, but it's not what real heroes do![mis of 40]") when Verses Rev is quicknear.

chapter Dopy Pod

understand "pod op" as a mistake ("But what sort of op?[mis of 41]") when player is in Dopy Pod.

understand "do pod" as a mistake ("But what to do to it? How to change it?[mis of 42]") when player is in Dopy Pod.

chapter Drawl Ward

understand "bony nob" as a mistake ("The Bond Nob's body weight is not an important issue, here.[mis of 43]") when Bond Nob is quicknear.

understand "bone nob" as a mistake ("Out of your league.[paragraph break]I mean, the Bond Nob has an active social life that revolves around bars, and you ... well, you're just a text adventure. That's barely a step above people who program text adventures![mis of 44]") when Bond Nob is quicknear.
...
understand "bong nob" as a mistake ("The Bond Nob probably knows someone but prefers alcohol.[mis of 46]") when Bond Nob is quicknear.
...
understand "un gnu" as a mistake ("Eliminating the perpetrator won't eliminate what they've dung. Uh, dun. Er, done.[mis of 49]") when gnu dung is quicknear.
...
understand "stinko knits" as a mistake ("There's time to get loaded after solving things. Or drunk. Nurd.[mis of 90]") when stinky knits are quicknear.

understand "dent Ned" as a mistake ("Less violence, more subtlety.[mis of 91]") when Ned is quicknear.

understand "bra garb" as a mistake ("I've tried to keep this game gender neutral.[mis of 92]") when brag garb is quicknear.
...
understand "mar tram" as a mistake ("No. [if epicer recipe is xed]You need it to build the north-tron[else]It must be good for something[end if].[mis of 99]") when martini tram is quicknear.

understand "nair Ian" as a mistake ("That would be painful and embarrassing enough to chase him, or someone named Brian, off, but alas, you don't have anything to do the job[if player has nat's tan]. The bottle of Nat's Tan doesn't count[end if].[mis of 100]") when Ian is quicknear.

understand "naif Ian" as a mistake ("Sadly, mind control is beyond your powers.[mis of 101]") when Ian is quicknear.

understand "nain Ian" as a mistake ("Owning/pwning would embarrass Ian, but that is too archaic a synonym.[mis of 102]") when Ian is quicknear.

understand "mo nom" as a mistake ("Greedy! There's enough food to find around here, really.[mis of 103]") when player is in Mont Nom.
...
understand "tamp mat" as a mistake ("It's already pretty beaten down.[mis of 105]") when player is in Motto Bottom and tame mat is in Motto Bottom.

understand "gurn rug" as a mistake ("It's a guru rug. It's too good to be moved by such a cheap bailout.[mis of 106]") when guru rug is quicknear.

chapter Moo Room

understand "moo boom" as a mistake ("You hear something strafe farts far away.[mis of 107]") when player is in Moo Room.

understand "moo doom" as a mistake ("Die? I'd...[mis of 108]") when player is in Moo Room.
...
understand "poo goop" as a mistake ("The coop is intended to prevent AGAINST having to carry yucky stuff, here.[mis of 112]") when poo coop is quicknear.

understand "poo hoop" and "poo loop" as a mistake ("No, the coop needs to hold something.[mis of 113]") when poo coop is quicknear.

understand "poo woop" as a mistake ("How or why it excites you, I don't want to know.[mis of 114]") when poo coop is quicknear.

understand "poo soop" as a mistake ("Good thing this isn't a cooking sim.[mis of 115]") when poo coop is quicknear.

chapter My Gym

understand "evade dave" as a mistake ("Dave's not here, man![mis of 116]") when player is in My Gym and Dave is moot.

understand "wasp saw" as a mistake ("You don't need the wash saw to turn into something that might sting you, especially since you are carrying it.[mis of 117]") when wash saw is quicknear.

understand "sto bots" as a mistake ("No cool robots pop out.[mis of 118]") when sto lots is quicknear.

understand "sto dots" as a mistake ("The Sto Lots remains unadorned.[mis of 119]") when sto lots is quicknear.

understand "sto gots" as a mistake ("Yes, you gots a lot of space, and you will gots a lot of stuff as the game goes on.[mis of 120]") when sto lots is quicknear.

understand "sto nots" as a mistake ("That would defeat the purpose![mis of 121]") when sto lots is quicknear.

understand "sto pots" as a mistake("No, it's more efficient as one entity. Also, this is not a cooking sim.[mis of 192]") when sto lots is quicknear.

understand "sto sots" as a mistake ("It's not big enough to be a drunk tank.[mis of 122]") when sto lots is quicknear.
...
understand "sleet eels" as a mistake ("They are alive. Turning them to metal would be cruel.[mis of 125]") when sleep eels are quicknear.

understand "sleek eels" as a mistake ("The eels don't need dexterity. They need comfort. They are slippery enough.[mis of 126]") when sleep eels are quicknear.

chapter Pro Corp

understand "sci bics" as a mistake ("You don't need any exotic writing implements.[mis of 127]") when player is in Pro Corp.

understand "sci dics" as a mistake ("You don't have time to learn weird terminology now.[mis of 128]") when player is in Pro Corp.

understand "sci fics" as a mistake ("But you already have reading material![mis of 129]") when player is in Pro Corp.

understand "sci mics" as a mistake ("Your experience remains relatively quiet but also free of static.[mis of 130]") when player is in Pro Corp.

understand "sci sics" as a mistake ("You think you spy a typo somewhere in the sci pics, leaving you feel free to feel smarter than something you don't unerstand. Go, you![mis of 131]") when player is in Pro Corp.

understand "sci tics" as a mistake ("You laugh at how silly the sci pics are, then sniff a bit, then tap your head.[mis of 132]") when player is in Pro Corp.

understand "psi lisp" as a mistake ("The Psi Wisp can't speak.[mis of 133]") when Psi Wisp is quicknear.

understand "line nil" as a mistake ("The Link Nil security system fails to turn into a line and vanish. That's pretty secure![mis of 134]") when player is in Pro Corp.

understand "dna land" as a mistake ("Biochemistry has its own nuances with symmetry, but we're sticking with something a lot dumber, here.[mis of 135]") when DNA band is quicknear or DNA hand is quicknear.

understand "DNA hand" as a mistake ("Right idea, but you can't do it on your own. You need technology to help you.[mis of 136]") when DNA band is quicknear.

understand "DNA sand" as a mistake ("That will happen with the passage of time.[mis of 137]") when DNA band is quicknear or DNA hand is quicknear.

understand "dna wand" as a mistake ("No. You know TRUE MAGIC MUST COME FROM WITHIN.[mis of 138]") when DNA band is quicknear or DNA hand is quicknear.

understand "band nab" as a mistake ("Mr. Arm tries to grip his own wrist but can't quite.[mis of 139]") when Mr Arm is quicknear.

understand "bank nab" as a mistake ("Whoah! You're one of the good guys, here.[mis of 140]") when Mr Arm is quicknear.

understand "mra arm" as a mistake ("No! Mr. Arm is on the side of social justice.[mis of 141]") when Mr Arm is quicknear.
...
understand "golf log" as a mistake ("There is no Par Trap or Tee Meet to navigate here, so you don't need to make a golf log.[mis of 144]") when gold log is quicknear.

understand "rm mr" as a mistake ("No, Mr. Arm will be helpful. (Spoiler: he'll leave for better things once he has helped, so happy endings all around. Yay.[mis of 145]") when Mr Arm is quicknear.
...
understand "yarn ray" as a mistake ("If you want more story, then sorry, this one's nearly at an end.[mis of 148]") when player has yard ray.

understand "yarg ray" and "yarr ray" as a mistake ("Becoming a pirate at the end? A clever heel turn![mis of 149]") when player has yard ray.
...
understand "stare rats" as a mistake ("You try to win a blinking contest, and maybe you could with one, but not that many.[mis of 154]") when stark rats are quicknear.

understand "start rats" as a mistake ("You sort of need to stop them, instead.[mis of 155]") when stark rats are quicknear.

understand "star rats" as a mistake ("You would rather they didn't star in your adventure, here. Must be some way to dispose of them.[mis of 156]") when stark rats are quicknear.

section gift fig

understand "gif fig" as a mistake ("No graphics, here![mis of 157]") when gift fig is quicknear.

understand "gift fig" as a mistake ("It already is one. And you don't need to pass it on.[mis of 158]") when gift fig is quicknear.

understand "gi fig" as a mistake ("No violence, here![mis of 159]") when gift fig is quicknear.

chapter Sneer Greens

chapter Yack Cay

understand "share rahs" as a mistake ("You're on this quest by yourself.[mis of 160]") when sharp rahs are quicknear.

understand "shark rahs" as a mistake ("You don't want to alert any land sharks.[mis of 161]") when sharp rahs are quicknear.

understand "shard rahs" as a mistake ("The rahs are on paper, and besides, they might be useful.[mis of 162]") when sharp rahs are quicknear.

understand "story rots" as a mistake ("No, the storm rots help keep you focused on the story. They aren't blocking anything. Or good for anything.[mis of 163]") when player is in Yack Cay.

understand "stork rots" as a mistake ("You don't want to know what sort of carcasses are buried in the swamp.[mis of 164]") when player is in Yack Cay.

understand "store rots" as a mistake ("You don't need to buy anything in this game, and any store wouldn't sell anything good.[mis of 165]") when player is in Yack Cay.
...
understand "told lot" as a mistake ("[if cross orc is in Toll Lot]The cross orc isn't open to verbal negotiation[else]You pretend you won an argument against the cross orc and didn't just hand over money[end if].[mis of 168]") when player is in Toll Lot.

understand "crop orc" as a mistake ("That attack would boomerang, and not just because this is a palindrome-y game. The orc is lots, lots bigger than you.[paragraph break]Also, there is no farm nearby.[mis of 169]") when cross orc is quicknear.

understand "croc orc" as a mistake ("The orc is fearsome enough without becoming a total genetic monstrosity.[mis of 170]") when cross orc is quicknear.

understand "crow orc" as a mistake ("The orc remains silent (yay) and flightless (boo).[mis of 171]") when cross orc is quicknear.

understand "cram arc" as a mistake ("Litterbug. Besides, you need pretty much everything you're carrying. And nothing would fit, anyway.[mis of 172]") when player is in Toll Lot.

understand "cray arc" as a mistake ("The arc doesn't need to change shape or become more volatile.[mis of 173]") when player is in Toll Lot.

understand "crap arc" as a mistake ("You might cause a mudslide, or worse.[mis of 174]") when player is in Toll Lot or player is in Scrap Arcs.

understand "crass arc" as a mistake ("[if cross orc is in Toll Lot]The cross orc and crag arc don't fuse together. Rats[else]You spend a few seconds feeling deeply offended by the crag arc[end if].[mis of 175]") when player is in Toll Lot or player is in Scrap Arcs.
...
checkoffs is a list of truth states variable. checkoffs is { false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false }.
