...
SOME DEMOS	yahoo hay	straw arts	--	hay-gone rule	true	true	false	false	true	false	Grebeberg	Moo Room	false	"With the help of SOME DEMOS, you (after several grunts of 'STRAIN! I! ARTS!') manage to rejig and bend and snap the hay into something more aesthetically pleasing: straw arts! You're so enthusiastic, you even tear up SOME DEMOS and garnish your new straw arts. It just feels right."
...
instead of inserting into the tract cart:
	try useoning noun with second noun;
...
the Elan Ale is a drinkable thing. description is "It's labeled as CLASS Alc, unsurprisingly, unlike Red Ice Cider or Zoo Booz, clashs-alc people use to gete drunk and rowdy. It's about the size of a pint nip."
...
carry out aiding:
	...
	if being-chased is true:
		if chase-person is kayo yak:
			...
			if player is in trial lair, say "[one of]The kayo yak can take out the ergot ogre.[or]You just need to give the right command to the kayo yak.[or]YAK ???? [or]YAK OKAY [stopping](no comma)." instead;
...
this is the dopy-pod-hint rule:
	...
	if search-hint-room is true, the rule succeeds;
	if player does not have demo med, say "Take the demo med." instead;
...
this is the yell-alley-hint rule:
	...
	if search-hint-room is true, the rule succeeds;
	if player does not have mayo yam, say "TAKE MAYO YAM." instead;
